    ...
    public class OperationLogic
    {
        ...
        public List<tblEnumCategory> GetEnumCategorys()
        {
            ...
            try
            {
                using (var context = new EmsalDBEntities())
                {
                    ...
                    var pcatalogs = (from p in context.tblEnumCategories where  p.Status==1
                                     select p);
        ...
        public List<tblEnumValue> GetEnumValues()
        {
            ...
            try
            {
                using (var context = new EmsalDBEntities())
                {
                    ...
                    var pcatalogs = (from p in context.tblEnumValues where   p.Status==1
                                     select p);
        ...
        public List<tblPRM_AdminUnit> GetPRM_AdminUnits()
        {
            try
            {
                using (var context = new EmsalDBEntities())
                {
                    var countries = (from p in context.tblPRM_AdminUnit where p.Status==1
                                     select p);
        ...
        public List<tblPRM_Thoroughfare> GetPRM_Thoroughfares()
        {
            try
            {
                using (var context = new EmsalDBEntities())
                {
                    var Thoroughfares = (from p in context.tblPRM_Thoroughfare where  p.Status==1
                                         select p);
        ...
        public List<tblAddress> GetAddresses()
        {
            try
            {
                using (var context = new EmsalDBEntities())
                {
                    var addresses = (from p in context.tblAddresses where  p.Status==1
                                     select p); 
        ...
        public List<tblProductAddress> GetProductAddresses()
        {
            try
            {
                using (var context = new EmsalDBEntities())
                {
                    var offerAddresses = (from p in context.tblProductAddresses where  p.Status==1
                                          select p);
        ...
        public List<tblProductCatalog> GetProductCatalogs()
        {
            ...
            try
            {
                using (var context = new EmsalDBEntities())
                {
                    ...
                    var pcatalogs = (from p in context.tblProductCatalogs where  p.Status==1
                                     select p);
        ...
        public List<tblCommunication> GetCommunications()
        {
            ...
            try
            {
                using (var context = new EmsalDBEntities())
                {
                    ...
                    var pcatalogs = (from p in context.tblCommunications where  p.Status==1
                                     select p);
        ...
        public List<tblOffer_Production> GetOffer_Productions()
        {
            ...
            try
            {
                using (var context = new EmsalDBEntities())
                {
                    ...
                    var pcatalogs = (from p in context.tblOffer_Production where  p.Status==1
                                     select p);
        ...
        public List<tblPotential_Production> GetPotential_Productions()
        {
            ...
            try
            {
                using (var context = new EmsalDBEntities())
                {
                    ...
                    var pcatalogs = (from p in context.tblPotential_Production where  p.Status==1
                                     select p);
        ...
        public List<tblDemand_Production> GetDemand_Productions()
        {
            ...
            try
            {
                using (var context = new EmsalDBEntities())
                {
                    ...
                    var pcatalogs = (from p in context.tblDemand_Production where  p.Status==1
                                     select p);
        ...
        public List<tblAnnouncement> GetAnnouncements()
        {
            ...
            try
            {
                using (var context = new EmsalDBEntities())
                {
                    ...
                    var pcatalogs = (from p in context.tblAnnouncements where  p.Status==1
                                     select p);
        ...
        public tblAnnouncement GetAnnouncementDetailsById(Int64 ID)
        {
            ...
            try
            {
                using (var context = new EmsalDBEntities())
                {
                    ...
                    var ecatalogs = (from p in context.tblAnnouncements
                                     where p.Id == ID && p.Status == 1 && p.startDate <= curentDate && p.endDate <= curentDate
                                     select p).FirstOrDefault();
        ...
        public List<tblAnnouncement> GetAnnouncementDetailsByProductId(Int64 productId)
        {
            Int64 curentDate = DateTime.Now.Ticks;
        ...
        public List<tblAnnouncement> GetAnnouncementDetails()
        {
            Int64 curentDate = DateTime.Now.Ticks;
            try
            {
        ...
        public List<tblEmployee> GetEmployees()
        {
            ...
            try
            {
                using (var context = new EmsalDBEntities())
                {
                    ...
                    var pcatalogs = (from p in context.tblEmployees where  p.Status==1
                                     select p);
        ...
        public List<tblUser> GetUsers()
        {
            ...
            try
            {
                using (var context = new EmsalDBEntities())
                {
                    ...
                    var pcatalogs = (from p in context.tblUsers where  p.Status==1
                                     select p);
        ...
        public List<tblRole> GetRoles()
        {
            ...
            try
            {
                using (var context = new EmsalDBEntities())
                {
                    ...
                    var pcatalogs = (from p in context.tblRoles where p.Status==1
                                     select p);
        ...
        public List<tblExpertise> GetExpertises()
        {
            ...
            try
            {
                using (var context = new EmsalDBEntities())
                {
                    ...
                    var pcatalogs = (from p in context.tblExpertises where  p.Status==1
                                     select p);
        ...
        public List<tblTitle> GetTitles()
        {
            ...
            try
            {
                using (var context = new EmsalDBEntities())
                {
                    ...
                    var pcatalogs = (from p in context.tblTitles where  p.Status==1
                                     select p);
        ...
        public List<tblParty> GetParties()
        {
            ...
            try
            {
                using (var context = new EmsalDBEntities())
                {
                    ...
                    var pcatalogs = (from p in context.tblParties where p.Status==1
                                     select p);
        ...
        public List<tblOrganization> GetOrganizations()
        {
            ...
            try
            {
                using (var context = new EmsalDBEntities())
                {
                    ...
                    var pcatalogs = (from p in context.tblOrganizations where  p.Status==1
                                     select p);
        ...
        public List<tblForeign_Organization> GetForeign_Organizations()
        {
            ...
            try
            {
                using (var context = new EmsalDBEntities())
                {
                    ...
                    var pcatalogs = (from p in context.tblForeign_Organization where p.Status==1
                                     select p);
            ...
            try
            {
                using (var context = new EmsalDBEntities())
                {
                    var organisations = (from p in context.tblForeign_Organization
                                         where p.parent_Id == ID && p.Status == 1 select p);
            ...
            try
            {
                using (var context = new EmsalDBEntities())
                {
                    ...
                    var productionDocumentList = (from p in context.tblProduction_Document
                                                  where p.Demand_Production_Id == prodDoc.Demand_Production_Id &&  p.Status == 1
                                                  select p);
        ...
        public List<tblProduction_Document> GetProductionDocuments()
        {
            ...
            try
            {
                using (var context = new EmsalDBEntities())
                {
                    ...
                    var documents = (from p in context.tblProduction_Document where p.Status==1
                                     select p);
        ...
        public List<tblProduct_Document> GetProductDocuments()
        {
            ...
            try
            {
                using (var context = new EmsalDBEntities())
                {
                    ...
                    var documents = (from p in context.tblProduct_Document where p.Status==1
                                     select p);
        ...
        public List<tblComMessage> GetNotReadComMessagesByToUserId(Int64 toUserId)
        {
            ...
            try
            {
                ...
                {
                    var items = (from p in context.tblComMessages
                                 where p.toUserID == toUserId && p.Status == 1 && p.isRead == 0
                                 select p);
