...
namespace Emsal.Utility.UtilityObjects
{
    public class ExceptionHandlingOperation
    {
        ...
        public static void SaveInputInformation(string inputValue, string ipNumber, string requestId, int lineNumber, ChannelEnum channel)
        {
            guid = IOUtil.GetGuid();
            LogType = "INPUT";
            RequestId = requestId;
        ...
        public static void SaveOutputInformation(string outputValue, string ipNumber, string requestId, int lineNumber, ChannelEnum channel)
        {
            guid = IOUtil.GetGuid();
            LogType = "OUTPUT";
            RequestId = requestId;
        ...
        public static void HandleException(Exception excp, string ipNumber, string requestId, ChannelEnum channel)
        {
            guid = IOUtil.GetGuid();
            LogType = "ERROR";
            RequestId = requestId;
